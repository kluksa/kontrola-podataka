# -*- coding: utf-8 -*-
"""
Created on Wed Nov  5 13:13:48 2014

@author: User

Klasa za minutni panel.
Wrapper koji sadrzi:
    1. Label sa informacijom o glavnom kanalu
    2. minutni canvas (canvas za prikaz satno agregiranih podataka)
...
class MinutniPanel(base3, form3):
    """
    ...
    def __init__(self, parent = None, defaulti = None, infoFrejmovi = None):
        ...
        #sredi title panela
        self.setWindowTitle('Minutni podaci')
        ...
        self.canvas = minutniCanvas.Graf(parent = self.widget1)
